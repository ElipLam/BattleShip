...
$meta['head_data'] = '
	...
	<link rel="stylesheet" type="text/css" media="screen" href="css/gameT.css" />
...
?>
		<div>
			<table>
			<tr>
				<th><a class="nav101" href="index.php<?php echo $GLOBALS['_?_DEBUG_QUERY']; ?>">Main Page</a></th>
				<th><a class="nav101" href="game.php<?php echo $GLOBALS['_?_DEBUG_QUERY']; ?>">Reload Game Board</a></th>
			</tr>
			</table>
		</div>
		<div id="contents">
		...
		<script src="/battleship/socket.io/dist/socket.io.js"></script>	
		
<?php
	$emit='';
	if ($Game->get_my_color() == "white"){
		$emit = '<input type="hidden" name="Player" id="Player" value="Player1">';				
	}
	else {
		$emit = '<input type="hidden" name="Player" id="Player" value="Player2">';
	}
	echo $emit;
?>
