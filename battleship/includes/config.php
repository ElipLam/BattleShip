...
/* ----------------- */
	...
	$GLOBALS['_DEFAULT_DATABASE']['username'] = 'root'; // the MySQL user's name
...
/* ------------- */
	...
	$GLOBALS['_ROOT_URI']   = 'http://localhost'; // The root URL of the game script (include closing / )
	$GLOBALS['_USEEMAIL']   = true; // SMTP operations.  Test it before putting it into production


/* Date settings */
/* ------------- */
	$GLOBALS['_DEFAULT_TIMEZONE'] = 'Asia/Ho_Chi_Minh'; // Your timezone (http://php.net/manual/en/timezones.php)
...
/* -------------- */
	...
	define('T_GAME_BOARD'   , $master_prefix . $game_prefix . 'game_board'); // the game player glue table
