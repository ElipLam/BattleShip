...
if(isset($_POST['Gamepad'])){
	$_SESSION['Player'] = $_POST['Gamepad'];
}
...
$contents .= '
	<div class="forms">
		<form method="post" action="'.$_SERVER['REQUEST_URI'].'"><div class="formdiv">
			...
			<select name="Gamepad">
				<option value="Player1">Gamepad1</option>
				<option value="Player2">Gamepad2</option>
			</select>
			<input type="submit" class="button" id="done" value="Done" />			
		</div></form>
	</div>
';
